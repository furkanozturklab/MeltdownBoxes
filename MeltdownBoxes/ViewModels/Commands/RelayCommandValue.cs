...
namespace MeltdownBoxes.ViewModels.Commands
{
    public class RelayCommandValue<T> : ICommand
    {
        ...
        public RelayCommandValue(Action<T> execute, Func<T, bool>? canExecute = null)
        {
